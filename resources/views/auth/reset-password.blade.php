...
<head>
  <meta charset="UTF-8" />
  <title>Set New Password - loodgieter.app</title>
...
<body>
  <div class="shell">
    ...
    <section class="hero">
      <span class="badge">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M12 1l3 6h6l-5 4 2 6-6-3-6 3 2-6-5-4h6l3-6z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        Set New Password
      </span>
      <h1 class="title">Reset Password</h1>
      <p class="subtitle">Enter your new password below. Make sure it's secure and easy to remember.</p>
    </section>
    ...
    <section class="form-wrap">
      ...
      <form method="POST" action="{{ route('password.store') }}" novalidate>
        ...
        <fieldset class="section-card">
          ...
          <div class="field">
            <label class="label" for="password">New password <span class="required">*</span></label>
            <div class="control">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 1v6m0 0L9 4m3 3l3-3M5 21h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        ...
        <div class="actions-card">
          <button class="btn" type="submit">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style="margin-right: 8px;"><path d="M9 12l2 2 4-4M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
            Reset Password
          </button>
