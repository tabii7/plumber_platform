  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .hero{
      ...
      background:
        radial-gradient(600px 300px at 0% 0%, rgba(34,211,238,.15), transparent 60%),
        radial-gradient(500px 500px at 100% 100%, rgba(6,182,212,.15), transparent 60%),
        linear-gradient(180deg, #0c142b 0%, #0b1224 100%);
      border-right:1px solid rgba(255,255,255,0.06);
    }
    @media (max-width: 860px){ .hero{border-right:none;border-bottom:1px solid rgba(255,255,255,0.06)} }
    .badge{
    ...
    .points{margin:22px 0 0;padding:0;list-style:none;color:#cbd5e1;font-size:14px}
    .points li{display:flex;gap:10px;align-items:flex-start;margin:10px 0}
    .points svg{flex:0 0 18px;margin-top:2px}
    .watermark{
      position:absolute;inset:auto -40px -40px auto;opacity:.06;pointer-events:none;
      font-size:140px;font-weight:800;letter-spacing:2px;rotate:-8deg;
    }

    /* Right side / form */
    .pane{padding:34px 30px 30px;background:rgba(7,12,26,.6)}
    .tabs{
    ...
    .tab{
      ...
      font-weight:600;font-size:14px;color:#cbd5e1;cursor:pointer;
      border:1px solid transparent;
    }
    .tab.active{
      background:linear-gradient(180deg, rgba(34,211,238,.16), rgba(34,211,238,.08));
      color:#e6fefe;border-color:rgba(34,211,238,.35);
    ...
    .ghost{
      background:transparent;color:#cbd5e1;border:1px solid rgba(255,255,255,.14);
      box-shadow:none;
    }
      ...
      <form method="POST" action="{{ route('register.store') }}" novalidate>
        ...
        <div class="field row-span-2">
          ...
          <div class="control">
            ...
            <input id="address" name="address" value="{{ old('address') }}" placeholder="Main Street" required>
          </div>
          @error('address')<div class="error">{{ $message }}</div>@enderror
          <div class="hint">Include apt/unit if applicable.</div>
        </div>

        <div class="field">
          <label class="label" for="number">No.</label>
          <div class="control">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M6 12h12M6 6h12M6 18h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
            <input id="number" name="number" value="{{ old('number') }}" placeholder="12A" required>
          </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 21s7-5.1 7-11a7 7 0 1 0-14 0c0 5.9 7 11 7 11z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        ...
        <div class="field">
          ...
          <div class="control">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M4 20h16M6 20V8l6-4 6 4v12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
            <input id="city" name="city" value="{{ old('city') }}" placeholder="Brussels" required>
          </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 4h12l-2 4 2 4H3zM15 8h6v12h-6z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
            <input id="country" name="country" value="{{ old('country','Belgium') }}" placeholder="Belgium" required>
          </div>
