...
<head>
  <meta charset="UTF-8" />
  <title>Create Client Account - loodgieter.app</title>
...
<body>
  <div class="shell">
    ...
    <section class="hero">
      ...
      <h1 class="title">Find a plumber faster.</h1>
      <p class="subtitle">Create your client account to get connected with qualified plumbers in your area. Quick, simple, and reliable service.</p>
      <ul class="points">
        <li>
          ...
          Get matched with nearby plumbers
        </li>
        <li>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
    ...
    <section class="form-wrap">
      ...
      <form method="POST" action="{{ route('client.register.store') }}" novalidate>
        ...
        <div class="actions-card">
          <button class="btn" type="submit">Create client account</button>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      async function searchSmart(qUser) {
        ...
        const osm = await fetchJSON(`https://nominatim.openstreetmap.org/search?format=jsonv2&limit=10&countrycodes=be&addressdetails=1&accept-language=nl&q=${encodeURIComponent(qUser)}`);
